...
Hello there! I'm passionate about the fascinating world of data science and artificial intelligence. Currently pursuing a Master degree in Artificial Intelligence. Proficient in quantitative skills such as statistics, mathematics, computing, and engineering. Experienced in data analysis, machine learning, predictive modeling, data mining, and big data. Familiar with programming languages like Python, as well as tools such as TensorFlow, scikit-learn, and SQL. Passionate about technology and constantly learning new concepts, as I believe learning is a continuous and exciting process. Fluent in both spoken and written Spanish and English.
...
<p align="justify">Este proyecto es una herramienta de IA para generar y mejorar contenido en plataformas como Instagram y TikTok, adaptado a audiencias, tonos e idiomas. Utiliza LLMs para crear contenido dinámico basado en información de productos de sitios de comercio electrónico.</p>
